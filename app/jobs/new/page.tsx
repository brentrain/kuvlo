                    ...
                    <div className="form-card">
                        <div className="form-row">
                            ...
                            <div className="form-group full">
                                ...
                                <input name="title" value={form.title} onChange={handleChange} placeholder="e.g. AC Repair, Lawn Mow, Electrical Panel" />
                            </div>
                            <div className="form-group">
                                <label>Job Type</label>
                                <input name="job_type" value={form.job_type} onChange={handleChange} placeholder="e.g. HVAC, Plumbing, Landscaping" />
                            </div>
                            <div className="form-group">
                                <label>Status</label>
                            ...
                            <div className="form-group">
                                ...
                                <input name="duration_min" type="number" value={form.duration_min} onChange={handleChange} placeholder="e.g. 90" />
                            </div>
                            <div className="form-group">
                                <label>Price ($)</label>
                                <input name="price_cents" type="number" step="0.01" value={form.price_cents} onChange={handleChange} placeholder="e.g. 150.00" />
                            </div>
                            <div className="form-group full">
                            ...
                            <div className="form-group full">
                                <label>Notes</label>
                                <textarea name="notes" value={form.notes} onChange={handleChange} placeholder="Job details, access instructions, anything worth noting..." />
                            </div>
                        </div>
                        ...
                        <div className="form-actions">
                            ...
                            <a href="/jobs" className="btn-cancel">Cancel</a>
                        </div>
                    </div>
                </main>
            </div>
